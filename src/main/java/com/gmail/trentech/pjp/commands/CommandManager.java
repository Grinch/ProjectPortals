...
public class CommandManager {
    ...
    private CommandSpec cmdWarpCreate = CommandSpec.builder()
            ...
            .arguments(GenericArguments.optional(GenericArguments.string(Text.of("name"))),
                    GenericArguments.optional(GenericArguments.string(Text.of("destination"))), GenericArguments.flags().flag("b")
    ...
    private CommandSpec cmdHomeRename = CommandSpec.builder()
            ...
            .arguments(GenericArguments.optional(GenericArguments.string(Text.of("oldName"))),
                    GenericArguments.optional(GenericArguments.string(Text.of("newName"))))
    ...
    private CommandSpec cmdPortalCreate = CommandSpec.builder()
            ...
            .arguments(GenericArguments.optional(GenericArguments.string(Text.of("name"))),
                    GenericArguments.optional(GenericArguments.string(Text.of("destination"))), GenericArguments.flags().flag("b")
                            .valueFlag(GenericArguments.string(Text.of("x,y,z")), "c")
                            .valueFlag(GenericArguments.enumValue(Text.of("direction"), Rotation.class), "d")
                            .valueFlag(GenericArguments.seq(GenericArguments.enumValue(Text.of("particle"), Particles.class),
                                    GenericArguments.optional(GenericArguments.enumValue(Text.of("color"), ParticleColor.class))), "e")
    ...
    private CommandSpec cmdPortalDestination = CommandSpec.builder()
            ...
            .arguments(GenericArguments.optional(new PortalElement(Text.of("name"), PortalType.PORTAL)),
